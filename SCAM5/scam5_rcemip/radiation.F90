...
!+ RCEMIP: output QRSC
            call add_default('QRSC'//diag(icall),     1, ' ')
!- RCEMIP
         endif
...
!+ RCEMIP: output QRLC
            call add_default('QRLC'//diag(icall),     1, ' ')
!- RCEMIP
         endif
...
!+ RCEMIP: Output radiative heating rate in the form of dT/dt instead of d(theta)/dt
!   call addfld ('HR',(/ 'lev' /), 'A','K/s','Heating rate needed for d(theta)/dt computation')
   call addfld ('HR',(/ 'lev' /), 'A','K/s','Heating rate needed for dT/dt computation')
